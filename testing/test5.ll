...
define dso_local i32 @main() #0 {
  ...
  call void @process_array(i32* noundef %15, i32 noundef 5)
  call void @manipulate_struct(%struct.Point* noundef %4)
  %16 = load double, double* @high, align 8
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double noundef %16)
  %18 = load i32, i32* @global_var, align 4
  %19 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 noundef %18)
  %20 = load i32, i32* %2, align 4
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 noundef %20)
  ...
  %27 = getelementptr inbounds %struct.Point, %struct.Point* %4, i32 0, i32 1
  %28 = load i32, i32* %27, align 4
  %29 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), i32 noundef %26, i32 noundef %28)
  %30 = load i32, i32* @x, align 4
  %31 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 noundef %30)
  ret i32 0
}
