...
@.str = private unnamed_addr constant [16 x i8] c"Local var: %lf\0A\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"Global var: %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"Local var: %d\0A\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"Array[2]: %d\0A\00", align 1
@.str.4 = private unnamed_addr constant [17 x i8] c"Point: (%d, %d)\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %5, i8* align 16 bitcast ([4 x i32]* @__const.main.array to i8*), i64 16, i1 false)
  ...
  call void @process_array(i32* noundef %13, i32 noundef 4)
  call void @manipulate_struct(%struct.Point* noundef %4)
  %14 = load double, double* @high, align 8
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double noundef %14)
  %16 = load i32, i32* @global_var, align 4
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 noundef %16)
  %18 = load i32, i32* %2, align 4
  %19 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 noundef %18)
  %20 = getelementptr inbounds [4 x i32], [4 x i32]* %3, i64 0, i64 2
  %21 = load i32, i32* %20, align 8
  %22 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i32 noundef %21)
  %23 = getelementptr inbounds %struct.Point, %struct.Point* %4, i32 0, i32 0
  %24 = load i32, i32* %23, align 4
  %25 = getelementptr inbounds %struct.Point, %struct.Point* %4, i32 0, i32 1
  %26 = load i32, i32* %25, align 4
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), i32 noundef %24, i32 noundef %26)
  %28 = load i32, i32* @x, align 4
  %29 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 noundef %28)
  ret i32 0
}
