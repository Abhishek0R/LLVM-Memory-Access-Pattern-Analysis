...
@.str = private unnamed_addr constant [15 x i8] c"Local var: %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [14 x i8] c"Array[2]: %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [17 x i8] c"Point: (%d, %d)\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  call void @process_array(i32* noundef %9, i32 noundef 5)
  call void @manipulate_struct(%struct.Point* noundef %4)
  %10 = load i32, i32* %2, align 4
  %11 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 noundef %10)
  %12 = getelementptr inbounds [5 x i32], [5 x i32]* %3, i64 0, i64 2
  %13 = load i32, i32* %12, align 8
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i32 noundef %13)
  ...
  %19 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0), i32 noundef %16, i32 noundef %18)
  ret i32 0
}
